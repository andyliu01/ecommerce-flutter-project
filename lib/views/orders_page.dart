// ignore_for_file: sort_child_properties_last, prefer_const_constructors, unnecessary_cast, sized_box_for_whitespace, use_build_context_synchronously
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    title: Text(
                        "${totalQuantityCalculator(orders[index].products)} Items Worth HK\u0024${orders[index].total}"),
                    subtitle: Text(
                    ...
                    .map((e) => Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "HK\u0024${e.single_price.toString()} x ${e.quantity.toString()} quantity",
                                style: TextStyle(fontWeight: FontWeight.bold),
                              ),
                              Text(
                                "HK\u0024${e.total_price.toString()}",
                                style: TextStyle(
