// ignore_for_file: prefer_final_fields, use_build_context_synchronously, prefer_const_constructors, avoid_print, sort_child_properties_last
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Sub Total: HK\u0024${cartData.totalCost}",
                      style: TextStyle(
                        fontSize: 16,
                      ),
                    ),
                    Divider(),
                    Text(
                      "Extra Discount: - HK\u0024$discount",
                      style: TextStyle(fontSize: 16),
                    ),
                    Divider(),
                    Text(
                      "Total Payable: HK\u0024${cartData.totalCost - discount}",
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.w500),
                    ),
                  ],
