// ignore_for_file: prefer_const_constructors, unnecessary_cast, unnecessary_string_interpolations, sort_child_properties_last
...
class _ZoneContainerState extends State<ZoneContainer> {
  Widget specialQuote({required int price, required int dis}) {
    ...
    List<String> quotes = ["Starting at HK\u0024$price", "Get upto $dis% off"];
