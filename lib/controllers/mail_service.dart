...
<tr style="border-bottom: 1px solid #ddd; padding:  8px;">
                ...
                <td style="padding: 8px;">HK\u0024${product.single_price}</td>
                <td style="padding: 8px;">${product.quantity}</td>
                <td style="padding: 8px;">HK\u0024${product.total_price}</td>
            </tr>
""").join("")}
    </tbody>
    ...
    <!-- discount and total will be in center -->
     <div class="total" style="width: 100%;   margin:   10px auto; max-width: 1000px;">
        ...
        <p style="text-align: right;  font-size: 16px; font-weight: 400;">Discount: - HK\u0024${order.discount}</p>
        <p style="text-align: right;  font-size: 20px; font-weight: 800;">Total: HK\u0024${order.total}</p>
     </div>
